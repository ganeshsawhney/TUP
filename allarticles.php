...
<?php
 require("database/dbconnection.php");
        session_start();    
$result = mysqli_query($connection, "select * from writeup where featured=1 ORDER BY dateofcreation DESC");
if (mysqli_num_rows($result) > 0) 
{       
while($row = mysqli_fetch_assoc($result)) 
{
$art=substr($row['text'], 0, 60);
...
?>
            ...
            <div class="col-sm-4 col-md-12">
                <div class="post-container" style="outline: 9px solid grey;">
...
<?php
 require("database/dbconnection.php");
		session_start();	
$result = mysqli_query($connection, "select * from writeup where featured=0 ORDER BY dateofcreation DESC");
if (mysqli_num_rows($result) > 0) 
{		
while($row = mysqli_fetch_assoc($result)) 
{
